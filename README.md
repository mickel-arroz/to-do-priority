...
3. En **SQL Editor** ejecuta en orden:
   ...
   - `supabase/migrations/0010_drop_missed_habit_log_status.sql` (ejecútala antes de desplegar el código que la acompaña: borra las filas `missed` del backfill viejo)
